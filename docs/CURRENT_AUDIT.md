...
- сотрудники и PIN загружаются централизованно из Apps Script;
- автообновление настроек выполняется при старте, возврате вкладки и раз в 6 часов.
- выбор даты больше не ограничен диапазоном; прошлая дата требует подтверждения.

Текущие значения по умолчанию:

- Даня — `3113`;
- Элина — `7407`;
- руководитель Юра — `1461`.
